...
export const metadata: Metadata = {
  title: 'Política de privacidad - Trejocode',
};
  ...
  <div className="w-full">
    <div className="flex justify-center">
      <div className="text-secondary-base container my-16 flex flex-col text-justify">
        <h2 className="mb-8 text-2xl font-semibold lg:text-4xl">POLÍTICA DE PRIVACIDAD</h2>
        <p className="leading-8">
          La presente Política de Privacidad establece los términos en que TrejoCode usa y protege la información que es
        ...
        <h3 className="my-8 text-2xl font-semibold">Información que es recogida</h3>
        <p className="leading-8">
        ...
        <h3 className="my-8 text-2xl font-semibold">Uso de la información recogida</h3>
        <p className="leading-8">
        ...
        <p className="leading-8">
          TrejoCode está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos
          los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no
          autorizado.
        </p>
        <h3 className="my-8 text-2xl font-semibold">Cookies</h3>
        <p className="leading-8">
          ...
          es que con ellas las web pueden reconocerte individualmente y por tanto brindarte el mejor servicio
        ...
        <h3 className="my-8 text-2xl font-semibold">Enlaces a Terceros</h3>
        <p className="leading-8">
        ...
        <h3 className="my-8 text-2xl font-semibold">Control de su información personal</h3>
        <p className="leading-8">
