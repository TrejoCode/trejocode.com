      ...
      <main className="w-full">
        <div className="flex justify-center">
          <div className="container flex flex-col my-16 text-secondary-base text-justify">
            <h2 className="text-2xl lg:text-4xl font-semibold mb-8">POLÍTICA DE PRIVACIDAD</h2>
            <p className="leading-8">
              La presente Política de Privacidad establece los términos en que TrejoCode usa y protege la información
            ...
            <h3 className="font-semibold text-2xl my-8">Información que es recogida</h3>
            <p className="leading-8">
            ...
            <h3 className="font-semibold text-2xl my-8">Uso de la información recogida</h3>
            <p className="leading-8">
              ...
              productos y servicios. Es posible que sean enviados correos electrónicos periódicamente a través de
              nuestro sitio con ofertas especiales, nuevos productos y otra información publicitaria que consideremos
            ...
            <p className="leading-8">
              TrejoCode está altamente comprometido para cumplir con el compromiso de mantener su información segura.
              Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún
              acceso no autorizado.
            </p>
            <h3 className="font-semibold text-2xl my-8">Cookies</h3>
            <p className="leading-8">
            ...
            <p className="leading-8">
              ...
              de su ordenador ni de usted, a menos de que usted así lo quiera y la proporcione directamente, visitas a
              una web. Usted puede aceptar o negar el uso de cookies, sin embargo la mayoría de navegadores aceptan
              cookies automáticamente pues sirve para tener un mejor servicio web. También usted puede cambiar la
              configuración de su ordenador para declinar las cookies. Si se declinan es posible que no pueda utilizar
              algunos de nuestros servicios.
            </p>
            <h3 className="font-semibold text-2xl my-8">Enlaces a Terceros</h3>
            <p className="leading-8">
            ...
            <h3 className="font-semibold text-2xl my-8">Control de su información personal</h3>
            <p className="leading-8">
            ...
            <p className="leading-8">
              TrejoCode Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
              momento.
            </p>
          </div>
        </div>
